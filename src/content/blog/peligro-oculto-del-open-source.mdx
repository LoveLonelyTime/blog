...
<div className="my-8 rounded-r-xl border-l-4 border-accent bg-accent/8 p-6">
  ...
  <p className="m-0 text-sm leading-relaxed text-foreground/75">
    Una vez en control, Jia Tan introdujo un *backdoor* (puerta trasera) de una
    sofisticación técnica aterradora. El código malicioso no estaba en el
    repositorio principal de GitHub de forma evidente, sino oculto dentro de
    archivos de prueba binarios aparentemente inofensivos. Durante el proceso de
    ...
    <strong>
      ...
      prácticamente cualquier servidor Linux moderno del mundo
    </strong>
